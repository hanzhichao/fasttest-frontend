...
export default [
  {
    ...
    meta: { title: '用例列表', icon: ViewModuleIcon },
    children: [
      {
        path: 'list',
        name: 'TestCaseList',
        component: () => import('@/pages/testcase/list/index.vue'),
        meta: { title: '用例列表' },
      },
      {
        path: 'detail/:id',
        name: 'TestCaseDetail',
        component: () => import('@/pages/testcase/detail/index.vue'),
        meta: { title: '用例详情' },
      },
      {
        path: 'add/',
        name: 'TestCaseForm',
        component: () => import('@/pages/testcase/add/index.vue'),
        meta: { title: '新建用例' },
      },
    ],
  },
